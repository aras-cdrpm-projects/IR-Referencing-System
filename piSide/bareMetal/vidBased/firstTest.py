'''
This code reads frames from a h264 file and after deriving the orientation, sends the quaternion values encoded using pickle through UDP
'''
import argparse
import cv2
import numpy as np
